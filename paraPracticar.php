<!-- Lo que está puesto aquí ya ha sido usado, asi que puedo borrarlo -->
...
if (isset($_GET["algo"])) {
    $algo = $_GET["algo"];
    $algoDespiezado = explode(", ", $algo);
    print_r($algoDespiezado);

    for ($i=0; $i < count($algoDespiezado); $i++) {
        echo "<br>" . $algoDespiezado[$i];
    }
    ...
    foreach ($algoDespiezado as $etiqueta) {
